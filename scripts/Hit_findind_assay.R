...
verbose = FALSE # Set to TRUE to print stuff on the terminal

# I am using 79 and 80 for positive and negative controls, respectively (MUST BE CONSISTENT WITH FUNCTION number_to_name)
...
compound_numbers1 = c(80, 1, 9, 17, 80, 2, 10, 18, 80, 3, 11, 19, 80, 4, 12, 20, 80, 5, 13, 21, 80, 6, 14, 79, 80, 7, 15, 79, 80, 8, 16, 80)
...
compound_numbers2 = c(22, 30, 38, 46, 23, 80, 39, 47, 24, 32, 40, 48, 25, 33, 41, 49, 26, 34, 42, 50, 27, 35, 43, 79, 28, 36, 44, 79, 29, 37, 45, 80)
...
compound_numbers3 = c(51, 59, 67, 75, 52, 60, 68, 76, 53, 61, 69, 77, 54, 62, 70, 78, 55, 63, 71, 31, 56, 64, 72, 79, 57, 65, 73, 79, 58, 66, 74, 80)
...
#compound_numbers4 = c(72, 80, 80, 80, 73, 80, 80, 80, 74, 80, 80, 80, 75, 80, 80, 80, 76, 80, 80, 80, 77, 80, 80, 80, 78, 80, 80, 80, 79, 80, 80, 80)
...
ggsave("plot_compuestos_BSub.jpg")


ggsave("plot_compuestos_BSub.pdf")
...
number_to_name <- function(n) {
	...
	names = c('KLG-4P', 'KLG-13A', 'KLG-9D', 'KLG-6M', 'KLG-12R', 'KLG-12T', 'KLG-11F', 'KLG-6I', 'KLG-9M', 'JK-8H', 'KLG-10B', 'KLG-14F', 'KLG-12J', 'KLG-6P', 'KLG-4A (CRUDE)', 'JM-3MTS', 'JM-4MTS', 'JM-2MTR', 'JM-23MTL', 'JM-11MLS', 'JM-11MTL', 'JM-12MTL', 'JM-4MFL', 'JM-6MFL', 'JM-1MFL', 'JM-9MIS', 'JM-16MIS', 'JM-5AMLS', 'JM-5MTL', 'JM-1BMLS', 'JM-8MIS', 'JM-15MIS', 'JM-MTR', 'JM-MIS', 'JM-MIR', 'JM-MFS', 'JM-MTL', 'JM-MIL', 'JM-MFR', 'JM-MFL', 'JM-MTS', 'MAN-SML-9596A', 'MAN-SML-105I', 'MAN-SML-105F', 'MAN-PES-B13', 'MAN-SML-105C', 'MAN-SMR-D180a', 'MAN-SML-110I', 'MAN-SMR-D75-78C23A', 'MAN-SMR-D108c', 'MAN-SML-117A', 'MAN-SMR-D8284CE12', 'MAN-SMR-D101H', 'MAN-SMR-D1416Y', 'MAN-SML-110M', 'MAN-SMR-D7C', 'MAN-SMR-D8B2', 'PERE', 'PELE', 'PESE', 'SMLE', 'SMLE-SMLE', 'MAN-SML-6465A (ACN LC-M5)', 'CLL', 'CKL', 'CLS', 'CKS', 'CKR', 'CLR', 'SMRE', 'KVBA-38B', 'KVBA-38A', 'KVBA-38C', 'KVPA-36C', 'KVPA-36L', 'KVBA-38D', 'KVBA-38F', 'NKR-2B', 'POS', 'NEG')
	return(names[n])
}
